...
*AgentsApi* | [**cancelAgentDelegation**](docs/AgentsApi.md#cancelagentdelegation) | **POST** /agent/delegations/{id}/cancel | Cancel an agent delegation
...
*AgentsApi* | [**getAgentDelegation**](docs/AgentsApi.md#getagentdelegation) | **GET** /agent/delegations/{id} | Get an agent delegation
...
*AgentsApi* | [**listThreadAgentDelegations**](docs/AgentsApi.md#listthreadagentdelegations) | **GET** /agent/threads/{thread_id}/delegations | List pending agent delegations for a thread
