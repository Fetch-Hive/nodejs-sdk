 ...
 *   - `artifact`  — a generated document or image descriptor (agent stream only)
...
export function SseChunkFromJSONTyped(json: any, ignoreDiscriminator: boolean): SseChunk {
    ...
    return {
        ...
        'artifact': json['artifact'] == null ? undefined : GeneratedArtifactFromJSON(json['artifact']),
...
export function SseChunkToJSONTyped(value?: SseChunk | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'artifact': GeneratedArtifactToJSON(value['artifact']),
