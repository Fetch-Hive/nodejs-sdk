...
```typescript
import type { PublicWorkspacesWorkspaceIdKnowledgeBasesKnowledgeBaseIdItemsPostRequestKnowledgeBaseItem } from '@fetch-hive/sdk'
...
const example = {
  ...
  "assetId": null,
} satisfies PublicWorkspacesWorkspaceIdKnowledgeBasesKnowledgeBaseIdItemsPostRequestKnowledgeBaseItem
...
const exampleParsed = JSON.parse(exampleJSON) as PublicWorkspacesWorkspaceIdKnowledgeBasesKnowledgeBaseIdItemsPostRequestKnowledgeBaseItem
