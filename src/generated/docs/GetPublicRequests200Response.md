...
```typescript
import type { GetPublicRequests200Response } from '@fetch-hive/sdk'
...
const example = {
  ...
  "userMetadata": null,
  "data": null,
} satisfies GetPublicRequests200Response
...
const exampleParsed = JSON.parse(exampleJSON) as GetPublicRequests200Response
